...
export class Server {
  ...
  private m_FilterMode: string = "none";
  private m_FilteredDevices: Array<RDM_Device> = this.m_Devices;
  private m_SortMode: string = "none";
  ...
  public GetDeviceList(): Array<RDM_Device> {
    return this.m_Devices;
  }

  public setLabelById(id: string, newLabel: string): void {
  ...
  public setAdressById(id: string, newAddress: number): void {
  ...
  public setModeById(id: string, newMode: number): void {
  ...
  public setFilterMode(mode: string) {
    this.m_FilterMode = mode;
    switch (mode) {
      case "na":
        this.m_FilteredDevices = this.m_Devices.filter(
          (device) => device.manufacturer === "Company NA"
        );
        break;

      case "tmb":
        this.m_FilteredDevices = this.m_Devices.filter(
          (device) => device.manufacturer === "TMB"
        );
        break;
  ...
  public setSortMode(mode: string) {
